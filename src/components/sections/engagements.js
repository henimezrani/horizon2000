      ...
      <div class="flex items-center justify-center mx-8 lg:mx-auto">
        <div class="max-w-5xl" itemprop="articleBody">
          ...
          <p className="text-xl md:text-2xl font-body font-extralight tracking-wider py-2">
            Afin d’assurer la qualité de nos services, La sécurité et la santé
            de nos équipes tout en œuvrant dans la préservation de la planète.
            Nous avons choisi de suivre un système intégré qui répond aux
            exigences des normes ISO 9001 version 2015, ISO 14000 version 2015,
            ISO 45001 version 2018 et SA8000 version 2014.
          </p>
          <p className="text-xl md:text-2xl font-body font-extralight tracking-wider py-2">
