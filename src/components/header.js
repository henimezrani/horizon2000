...
const Header = () => {
  ...
  return (
    <header className="w-full" data-active={scrolled}>
      <div className={`${scrolled ? "bg-white shadow-lg" : "bg-white py-6"}`}>
        {/* x-data="{ mobileMenuOpen: false}" */}
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
          <div className="flex justify-center items-center py-6 lg:justify-start lg:space-x-10">
            {/* Logo on the left */}
            <div className="flex justify-start lg:flex-1 truncate">
              <h1 className="text-xl font-bold trucate">
                <Link to="/">
                  <img
                    alt="Gatsby logo"
                    width={200}
            ...
            <div className="-mr-2 -my-2 ml-3 lg:hidden">
              <button
                ...
                type="button"
                className="bg-white inline-flex p-2 intems-center justify-center focus:outline-none"
              >
                <IconMenu />
              </button>
            </div>
            ...
            <nav className="hidden lg:flex space-x-10">
              {menuLinks.map((link, i) => (
                <React.Fragment key={link.url}>
                  <div className="text-base text-gray-500 hover:text-gray-700">
